...
In this chapter, I explore several ggplot2 extensions that enhance the design and communication of statistical graphics. Through this exercise, I demonstrate how to:
...
![](img/HoE2_1.jpg) We simply replace `geom_text()` by [`geom_text_repel()`](https://ggrepel.slowkow.com/reference/geom_text_repel.html) and `geom_label()` by [`geom_label_repel`](https://ggrepel.slowkow.com/reference/geom_text_repel.html).
