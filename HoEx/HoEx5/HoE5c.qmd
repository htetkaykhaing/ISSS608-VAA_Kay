...
In this chapter, the data of [World Happines 2018 report](https://worldhappiness.report/ed/2018/) will be used. The original data set is in Microsoft Excel format. It has been extracted and saved in csv file called **WHData-2018.csv**.
...
The data was loaded into a data frame, but it has to be a data matrix to make heatmap.
...
Before getting started, review the [Introduction to Heatmaply](https://cran.r-project.org/web/packages/heatmaply/vignettes/heatmaply.html) to have an overall understanding of the features and functions of Heatmaply package. Having the [user manual](https://cran.r-project.org/web/packages/heatmaply/heatmaply.pdf) of the package in hand is useful for reference purposes.
...
The default colour palette uses by **heatmaply** is *viridis*. heatmaply users, however, we can use other colour palettes in order to improve the aestheticness and visual friendliness of the heatmap.
