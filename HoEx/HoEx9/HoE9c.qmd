...
## 9.1 Overview
### 9.1.1 Objectives
In this chapter, we will use appropriate R methods to plot analytical maps.

### 9.1.2 Learning outcome
By the end of this chapter, we will be able to use appropriate functions of tmap and tidyverse to perform the following tasks:
...
For the purpose of this chapter, a prepared data set called *NGA_wp.rds* will be used. The data set is a polygon feature data.frame providing information on water point of Nigeria at the LGA level.
```{r}
